...
import { Mail, Lock, CheckCircle2, ShoppingBag, ArrowRight, Github } from "lucide-react"
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96 z-10">
          ...
          <div className="mt-8 z-10">
              ...
              <form onSubmit={handleSubmit(handleLogin)} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <input
                      ...
                      name="remember-me"
                      type="checkbox"
                      className="h-4 w-4 text-black focus:ring-black border-gray-300 rounded cursor-pointer transition"
                    />
                  ...
                  <div className="text-sm">
                    <a href="#" className="font-medium text-black hover:text-gray-700 hover:underline transition-all">
                ...
                <div>
                  <button
                    ...
                    className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-black hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black transition duration-200 disabled:opacity-70 disabled:cursor-not-allowed items-center gap-2"
                  >
            ...
            <p className="mt-8 text-center text-sm text-gray-600">
              ...
              <Link href="/register" className="font-semibold text-black hover:text-gray-800 hover:underline transition-all">
                Sign up for free
              </Link>
            </p>
          </div>
      ...
      <div className="hidden lg:block relative w-0 flex-1">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center p-12">
          <div className="max-w-xl text-center">
            {/* Feature lists for e-commerce */}
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl">
              <h3 className="text-3xl font-bold text-white mb-6">Discover New Arrivals</h3>
              <ul className="space-y-4 text-left text-white/90">
                <li className="flex items-center gap-3">
                  <CheckCircle2 className="w-6 h-6 text-green-400" />
                  <span className="text-lg">Exclusive offers and discounts</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle2 className="w-6 h-6 text-green-400" />
                ...
                <li className="flex items-center gap-3">
                  <CheckCircle2 className="w-6 h-6 text-green-400" />
                  <span className="text-lg">Free shipping on orders over $100</span>
                </li>
              </ul>
            </div>
          </div>
